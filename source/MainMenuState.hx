...
class MainMenuState extends MusicBeatState
{
	...
	var bg:FlxSprite = new FlxSprite(-89).loadGraphic(Paths.image('MainMenuThings/mBG_Main'));
	var checker:FlxBackdrop = new FlxBackdrop(Paths.image('MainMenuThings/Main_Checker'), 0.2, 0.2, true, true);
	...
	override function create()
	{
		...
		var side:FlxSprite = new FlxSprite(0).loadGraphic(Paths.image('MainMenuThings/Main_Side'));
