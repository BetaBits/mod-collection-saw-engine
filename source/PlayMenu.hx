...
class PlayMenu extends MusicBeatState
{
	...
	var optionShit:Array<String> = ['week', 'freeplay'];
	var camFollow:FlxObject;

	var bg:FlxSprite = new FlxSprite(-89).loadGraphic(Paths.image('PlayMenuThings/pBG_Main'));
	var checker:FlxBackdrop = new FlxBackdrop(Paths.image('PlayMenuThings/Play_Checker'), 0.2, 0.2, true, true);
	var gradientBar:FlxSprite = new FlxSprite(0,0).makeGraphic(FlxG.width, 300, 0xFFAA00AA);
	var side:FlxSprite = new FlxSprite(0).loadGraphic(Paths.image('PlayMenuThings/Play_Bottom'));
