...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			case 'gf':
				// GIRLFRIEND CODE
				tex = Paths.getSparrowAtlas('characters/base/GF_assets');
				frames = tex;
			...
			case 'gf-christmas':
				tex = Paths.getSparrowAtlas('characters/base/gfChristmas');
				frames = tex;
				animation.addByPrefix('cheer', 'GF Cheer', 24, false);
				animation.addByPrefix('singLEFT', 'GF left note', 24, false);
				animation.addByPrefix('singRIGHT', 'GF Right Note', 24, false);
			...
			case 'gf-car':
				tex = Paths.getSparrowAtlas('characters/base/gfCar');
				frames = tex;
			...
			case 'gf-pixel':
				tex = Paths.getSparrowAtlas('characters/base/gfPixel');
				frames = tex;
			...
			case 'picoSpeaker':
				tex = Paths.getSparrowAtlas('characters/base/picoSpeaker', 'shared');
				frames = tex;
			...
			case 'gf-tankmen':		 
				frames = Paths.getSparrowAtlas('characters/base/gfTankmen', 'shared');
			...
			case 'dad':
				...
				tex = Paths.getSparrowAtlas('characters/base/DADDY_DEAREST', 'shared');
				frames = tex;
				...
				playAnim('idle');
			case 'spooky':
				tex = Paths.getSparrowAtlas('characters/base/spooky_kids_assets');
				frames = tex;
				...
				playAnim('danceRight');
			case 'mom':
				tex = Paths.getSparrowAtlas('characters/base/Mom_Assets');
				frames = tex;
			...
			case 'mom-car':
				tex = Paths.getSparrowAtlas('characters/base/momCar');
				frames = tex;
				...
				playAnim('idle');
			case 'monster':
				tex = Paths.getSparrowAtlas('characters/base/Monster_Assets');
				frames = tex;
			...
			case 'monster-christmas':
				tex = Paths.getSparrowAtlas('characters/base/monsterChristmas');
				frames = tex;
				animation.addByPrefix('idle', 'monster idle', 24, false);
				animation.addByPrefix('singUP', 'monster up note', 24, false);
				animation.addByPrefix('singDOWN', 'monster down', 24, false);
				...
				playAnim('idle');
			case 'pico':
				tex = Paths.getSparrowAtlas('characters/base/Pico_FNF_assetss');
				frames = tex;
			...
			case 'bf':
				var tex = Paths.getSparrowAtlas('characters/base/BOYFRIEND', 'shared');
				frames = tex;
			...
			case 'bf-christmas':
				var tex = Paths.getSparrowAtlas('characters/base/bfChristmas');
				frames = tex;
				animation.addByPrefix('idle', 'BF idle dance', 24, false);
				animation.addByPrefix('singUP', 'BF NOTE UP0', 24, false);
				animation.addByPrefix('singLEFT', 'BF NOTE LEFT0', 24, false);
				...
				flipX = true;
			case 'bf-car':
				var tex = Paths.getSparrowAtlas('characters/base/bfCar');
				frames = tex;
				animation.addByPrefix('idle', 'BF idle dance', 24, false);
				animation.addByPrefix('singUP', 'BF NOTE UP0', 24, false);
				animation.addByPrefix('singLEFT', 'BF NOTE LEFT0', 24, false);
				...
				flipX = true;
			case 'bf-pixel':
				frames = Paths.getSparrowAtlas('characters/base/bfPixel');
				...
				flipX = true;
			case 'bf-pixel-dead':
				frames = Paths.getSparrowAtlas('characters/base/bfPixelsDEAD');
			...
			case 'bf-holding-gf':
				...
				frames = Paths.getSparrowAtlas('characters/base/bfAndGF', 'shared');
			...
			case 'bf-holding-gf-dead':
				...
				frames = Paths.getSparrowAtlas('characters/base/bfHoldingGF-DEAD', 'shared');
			...
			case 'senpai':
				frames = Paths.getSparrowAtlas('characters/base/senpai');
			...
			case 'spirit':
				frames = Paths.getPackerAtlas('characters/base/spirit');
			...
			case 'parents-christmas':
				frames = Paths.getSparrowAtlas('characters/base/mom_dad_christmas_assets');
				...
				playAnim('idle');
			case 'tankman':
				tex = Paths.getSparrowAtlas('characters/base/tankmanCaptain', 'shared');
				frames = tex;
				...
				addOffset("oldSingUP", 50,56);
				addOffset("singRIGHT", -12,-27);
				addOffset("singLEFT", 90,-14);
				addOffset("singDOWN", 80,-100);
				addOffset("oldSingDOWN", 80,-100);
				//addOffset("ughAnim", 45, 0);
				addOffset("prettyGoodAnim", 0,15);
				playAnim('idle');
				flipX = true;
			case 'whitty': // whitty reg (lofight,overhead)
				tex = Paths.getSparrowAtlas('characters/whitty/WhittySprites', 'shared');
				frames = tex;
			...
			case 'whittyCrazy': // whitty crazy (ballistic)
				tex = Paths.getSparrowAtlas('characters/whitty/WhittyCrazy', 'shared');
				frames = tex;
			...
			case 'gf-whitty':
				tex = Paths.getSparrowAtlas('characters/whitty/GF_Standing_Sway', 'shared');
				frames = tex;
